...
{
    // This class represents the network cache for the game state and registers
    // the RPC used to update killfeed entries.
    ...
    // This class maps the game state properties received over the network.
    ...
    // This class defines the structure of a killfeed entry in the replay.
